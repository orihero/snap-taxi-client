    ...
    return (
        <View style={{ width: props.width, flexDirection: 'row', justifyContent: 'center', alignSelf: 'center', marginTop: 1}}>
            ...
            <Svg width={70.508} height={15.224} viewBox="0 0 70.508 15.224">
                ...
                <View style={{position: 'absolute', backgroundColor: '#fff', height: 15.224, right: 0, width: 1}}/>
                <Defs>
                ...
                >
                    <G data-name="Path 2971" fill="#fff">
                        <Path
            ...
            <View style={{backgroundColor: '#fff', height: 15.224, flex: 1,  borderTopRightRadius: 15}}/>
        </View>
    )
}
