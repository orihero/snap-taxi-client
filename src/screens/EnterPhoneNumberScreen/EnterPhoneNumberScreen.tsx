...
const EnterPhoneNumberScreen = ({navigation}) => {
    ...
    // constants openContactPicker = () => {
    //     ContactPickerBridge.openContactPicker((result) => {
    //         setContact(result.data)
    //     });
    // };

    // constants checkContactPermissions = async () => {
    //     constants granted = await PermissionsAndroid.request(PermissionsAndroid.PERMISSIONS.READ_CONTACTS);
